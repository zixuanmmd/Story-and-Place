          ...
          <>
            <section className="profile-hero">
              ...
              <div className="profile-actions">
                ...
                {user?.id === profile.id ? <div className="record-actions"><Link className="secondary-button nav-link" href="/settings">编辑资料</Link><Link className="secondary-button nav-link" href="/my-records">我的记录</Link><Link className="secondary-button nav-link" href="/timeline">我的时间线</Link><Link className="secondary-button nav-link" href="/groups">我的群组</Link></div> : <button className="primary-button" type="button" aria-pressed={isFollowing} disabled={busy} onClick={() => void toggleFollow()}>{busy ? "处理中…" : isFollowing ? "取消关注" : "关注"}</button>}
